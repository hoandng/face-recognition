...
class Login_Window:
    ...
    #     bg=PIL.Image.open(path_root + "ImageFaceDetect\clock.png")
    #     bg=bg.resize((300,300),PIL.Image.LANCZOS)
    ...
    #     clock.save(path_root + "ImageFaceDetect\clock_new.png")
    def reset(self):
        self.var_email.set("")
    ...
    def working(self):
        ...
        self.img=ImageTk.PhotoImage(file= path_root + "ImageFaceDetect\clock_new.png")
