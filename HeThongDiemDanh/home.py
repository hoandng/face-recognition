...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img=PIL.Image.open(path_root + r"ImageFaceDetect\epu1.jpg")
        ...
        #anh 2
        img1 = PIL.Image.open(path_root + r"ImageFaceDetect\student2.jpg")
        ...
        #anh3
        img2 = PIL.Image.open(path_root + r"ImageFaceDetect\facedt.png")
        ...
        #bg
        img3 = PIL.Image.open(path_root + r"ImageFaceDetect\fd1.jpg")
        ...
        #student button
        img4 = PIL.Image.open(path_root + r"ImageFaceDetect\sv2.jpg")
        ...
        #detect_button
        img5 = PIL.Image.open(path_root + r"ImageFaceDetect\images.jpg")
        ...
        #diem danh
        img6 = PIL.Image.open(path_root + r"ImageFaceDetect\reg1.jpg")
        ...
        #help
        img7 = PIL.Image.open(path_root + r"ImageFaceDetect\help.jpg")
        ...
        #Train
        img8 = PIL.Image.open(path_root + r"ImageFaceDetect\train.jpg")
        ...
        #QL anh
        img9 = PIL.Image.open(path_root + r"ImageFaceDetect\anh.png")
        ...
        #Thong tin laptrinh
        img10 = PIL.Image.open(path_root + r"ImageFaceDetect\manage.jpg")
        ...
        #exit
        img11 = PIL.Image.open(path_root + r"ImageFaceDetect\exit.png")
