...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #background
        print(value_from_p1)
        img3 = PIL.Image.open(path_root + r"ImageFaceDetect\\utc-bg.png")
        ...
        self.heading = Label(self.root, text=self.txt, font=("Times New Roman", 17, "bold"), bg="white", fg="#608def",
                             bd=5, relief=FLAT)
        self.heading.place(x=360, y=40, width=500)
        # self.slider()
        # self.heading_color()
        ...
        if(value_from_p1=="0"):
            ...
            self.account = row[0]
        img_peop = PIL.Image.open(path_root + r"ImageFaceDetect\\peop.png")
        ...
        #=======logout==========
        img_logout = PIL.Image.open(path_root + r"ImageFaceDetect\\logout.png")
        ...
        #=============Button================
        img_btn1 = PIL.Image.open(path_root + r"ImageFaceDetect\\report.png")
        ...
        #============student================
        img_btn2 = PIL.Image.open(path_root + r"ImageFaceDetect\\student.png")
        ...
        #============nhan dien============
        img_btn3 = PIL.Image.open(path_root + r"ImageFaceDetect\\nhandien.png")
        ...
        #===========diem-danh===============
        img_btn4 = PIL.Image.open(path_root + r"ImageFaceDetect\\ghichu.png")
        ...
        #==========monhoc=================
        img_btn5 = PIL.Image.open(path_root + r"ImageFaceDetect\\book.png")
        ...
        #==========thaygiao=============
        img_btn6 = PIL.Image.open(path_root + r"ImageFaceDetect\\teacher.png")
        ...
        #==========chuyen nganh================
        img_btn7 = PIL.Image.open(path_root + r"ImageFaceDetect\\lesson.png")
        ...
        #==========XemAnh===============
        img_btn8 = PIL.Image.open(path_root + r"ImageFaceDetect\\picture.png")
