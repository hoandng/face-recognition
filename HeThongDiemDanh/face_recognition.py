...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        img3 = PIL.Image.open(path_root + r"ImageFaceDetect\bg1.png")
        ...
        #btn Cam
        img_btn1 = PIL.Image.open(path_root + r"ImageFaceDetect\btnOpen.png")
        ...
        img_btn2 = PIL.Image.open(path_root + r"ImageFaceDetect\btnClose.png")
        ...
        self.img_right = PIL.Image.open(path_root + r"ImageFaceDetect\\unknow.jpg")
                ...
                try:
                        ...
                        if(self.type_attendance.get()=="Vào"):
                            if((d1 not in a)) or ((self.lessonid not in b)):
                                ...
                                cv2.imwrite(path_root + "DiemDanhImage\ " + masp + ".jpg",
                                           face_cropped)
                                #=============================Check_attendance===============================

                                self.img_right = PIL.Image.open(path_root + r"DiemDanhImage\ " + masp + ".jpg")
                                self.img_right = self.img_right.resize((190, 190), PIL.Image.LANCZOS)
                                self.photoimg_left = ImageTk.PhotoImage(self.img_right)
                            ...
                            if(masp not in att):
                                if ((d1 not in a)) or ((self.lessonid not in b)):
                                    ...
                                    cv2.imwrite(path_root + "DiemDanhImage\ " + masp +"Ra"+ ".jpg",
                                                face_cropped)
                                    # =============================Check_attendance===============================

                                    self.img_right = PIL.Image.open(path_root + r"DiemDanhImage\ " + masp +"Ra" +".jpg")
                                    self.img_right = self.img_right.resize((190, 190), PIL.Image.LANCZOS)
                                    self.photoimg_left = ImageTk.PhotoImage(self.img_right)
    ...
    def face_recog(self):
            ...
            def recognize(img,clf,faceCascade):
                ...
                return img
            faceCascade=cv2.CascadeClassifier(path_root + "haarcascade_frontalface_default.xml")
            clf=cv2.face.LBPHFaceRecognizer_create()
            clf.read(path_root + "classifier.xml")
