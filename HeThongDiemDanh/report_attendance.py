...
class Report:
    def __init__(self,root):
        ...
        img_student = PIL.Image.open(path_root + r"ImageFaceDetect\sv.png")
        ...
        img_att = PIL.Image.open(path_root + r"ImageFaceDetect\sodd.png")
        ...
        img_late = PIL.Image.open(path_root + r"ImageFaceDetect\late.png")
        # img_student = img_student.resize((50, 50), PIL.Image.LANCZOS)
        ...
        img_noatt = PIL.Image.open(path_root + r"ImageFaceDetect\vang.png")
        # img_student = img_student.resize((50, 50), PIL.Image.LANCZOS)
